...
export const reoptimizeCodes=(codes:string[],paid_by_id:Record<string,number>)=>json<ReoptimizationResult>("/v1/reoptimize",{method:"POST",body:JSON.stringify({codes,paid_by_id})});
